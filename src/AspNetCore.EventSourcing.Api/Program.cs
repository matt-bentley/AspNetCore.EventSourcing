using Autofac;
using AspNetCore.EventSourcing.Api.Infrastructure.Filters;
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1",
                    new OpenApiInfo
                    {
                        Title = "AspNetCore.EventSourcing API",
                        Version = "v1",
                        Description = "HTTP API for accessing AspNetCore.EventSourcing data"
                    });
